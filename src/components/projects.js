...
export default function Projects() {
  return (
    <section className="content projects flex-column py-5" id="projects">
      ...
      <Fade direction={"up"} top when={true} triggerOnce={true} delay={600}>
        <a
          className="btn btn-dark btn--github shadow my-1 d-flex justify-content-center align-items-center p-2"
          href={ROUTES.GITHUB_REPOSITORIES}
          target="_blank"
          rel="noreferrer"
        >
